...
<body>
	...
	<div class="row-fluid"style="margin-top: 40px;">
		...
		<div class="col-md-6">
			<form role="form"class="form-horizontal" action="${pageContext.request.contextPath}/admin/adminServlet?method=reg&updateId=${userBean.username }"method="post" id="checkForm">
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="depart"type="text"id="depart"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="director"type="text"id="director"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="hangye""type="text"id="hangye"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="education""type="text"id="education"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="zhicheng""type="text"id="zhicheng"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="address""type="text"id="address"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="e_code""type="text"id="e_code"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="Pnumber"type="text"id="Pnumber"value="${userBean.username }"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-9">
					<input class="form-control"name="dianhua"type="text"id="dianhua"value="${userBean.username }"/>
				</div>
			</div>
