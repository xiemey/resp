...
<body style="background-color:#dceefc">
	...
	<form action="${pageContext.request.contextPath}/admin/xuqiuServlet?method=zhengjishenehe&id=${zhengjibean.id }" method="post">
		...
		<a href="${pageContext.request.contextPath}/admin/xuqiuServlet?method=shenhe&status=0"><button type="button" class="btn btn-primary">返回</button></a>
	</form>
	</center>
					...
					<div class="modal-body">
						<form
							...
							<div class="form-group">
								<textarea  class="form-control" name="tuihuiliyou" rows="8" cols="120"
