...
public class Xuqiudao 
{
	...
	public List<Zhengjibean> needlsit()
	{
		Connection conn=DBUtil.getConn();
		Statement state=null;
		ResultSet rs=null;
		String sql="select * from zhengji where status>'0'";
	...
	public List<Zhengjibean> shenhe(int status)
	{
		...
		Statement state=null;
		ResultSet rs=null;
		String sql="select * from zhengji where status='"+status+"'";
		List<Zhengjibean> zhengjibeanlist=new ArrayList<Zhengjibean>();
		Zhengjibean zhengjibean=null;
		try
		{
	...
	public List<Zhengjibean> searchlsit(String jiname,int status)
	{
		...
		{ 
			if(jiname.equals(""))
			{
				sql="select * from zhengji where status>'0'";
			}
			else
			{
				sql="select * from zhengji where jiname='"+jiname+"' and status>'0' ";
			}
		...
		else
		{
			if(jiname.equals(""))
			{
				sql="select * from zhengji where status='"+status+"'";
			}
			else
			{
