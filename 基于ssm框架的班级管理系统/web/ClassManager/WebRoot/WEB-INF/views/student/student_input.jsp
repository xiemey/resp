				...
				<div class="col-xs-12">
					...
					<s:form action="student_save" cssClass="form-horizontal"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="stuNum" id="stuNum" placeholder="例如:20143050"
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<s:textfield name="stuPhone" id="stuPhone"
									placeholder="例如:12345678910" cssClass="col-xs-10 col-sm-5" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right"
							...
							<div class="col-sm-9">
								<s:textfield name="stuAddress" id="stuAddress"
									placeholder="例如:河北省石家庄市桥东区" cssClass="col-xs-10 col-sm-5" />
							</div>
						</div>
