...
<body>
	<%-- 	<s:debug /> --%>
	<s:form id="domainForm" action="score">
			...
			<div class="page-content">
				<div class="page-header">
					<h3>
						...
						<button id="btnallsave" class="btn btn-info"
										...
										<tbody>
											<s:iterator value="pageList.rows" status="st">
												<tr id="">
													...
													<td style="width: 10%"><input name="scoNum"
														style="border: 1px solid Gainsboro;"
														id="<s:property value='#st.index'/>" value="${scoNum}" /></td>
													<td style="width: 15%"><a href="#"
														onclick="update(this)"><button title="保存"
